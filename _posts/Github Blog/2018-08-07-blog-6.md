...
포스트 개수가 많아지다 보니 관리가 힘들어서 카테고리를 만들었다. 카테고리 만든 방법을 간단하게 정리하였다.<br><br><br>
...
<br>
(맨 바깥의 디렉토리) 계정명.github.io 폴더 안에 category 폴더를 만들어준다음 원하는 카테고리명의 markdown 파일을 추가해준다. <br>
...
<br>
위의 세가지 셋팅을 하고 나면 포스트를 작성할때 카테고리 항목만 추가하여 주면 카테고리 지정이 된다.<br>
