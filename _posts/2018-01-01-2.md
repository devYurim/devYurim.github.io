...
이번에 블로그 내용은 마크다운 문서를 작성하기 위하여 사용하는 에디터, 깃허브 블로그에 포스팅 적용방법 및 페이지 만드는 법을 정리하기 위하여 작성하였다.<br><br>
...
<center><img src="https://user-images.githubusercontent.com/20412850/34468412-ba059536-ef4b-11e7-90d4-3313e9fed8f9.png" width="60%"></center><br><br>


> **2. 마크다운 파일 생성**

깃허브 블로그 페이지는 <code>마크다운(Markdown) 문서(.md)</code>로 작성 한다.<br>
블로그 디렉터리를 확인하면 **posts** 라는 폴더가 있는데 이곳이 블로그 포스팅으로 작성한 파일을 넣어두는 부분이다. **제목은 왠만하면 영어 또는 숫자로 적는 것이 좋다. 한글로 작성하게 되면 가끔 인코딩 오류가 발생하여 페이지 로드 오류가 발생했다.**<br>
...
> **3. 깃허브(Github) 블로그에 업로드**

항상 깃허브에 변경사항을 적용할 때는 저장소에 커밋 및 푸쉬를 해주면 된다.
